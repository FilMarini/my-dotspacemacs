...
values."
  (setq-default
   ...
   dotspacemacs-additional-packages '(material-theme yasnippet-snippets)
...
you should place your code here."
  ...
  ;; Disable evil mode when running terminal
